...
def log(var_name, var_value):
    print("\033[1;31;46m{1} is {0}\033[0m".format(var_value, var_name))
...
anno_id = '11'
in_dir = os.path.join('/home/server/workspace/additionalExp/data', anno_id)
...
np.savez('results/ply/{0}.npz'.format(anno_id), parts=samples)